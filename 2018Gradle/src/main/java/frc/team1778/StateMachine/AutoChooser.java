...
public class AutoChooser {
  ...
  public AutoChooser() {
    ...
    chooser_action.addObject("LIFT_ONCE", new ModeSelection(LIFT_ONCE));
    ...
    chooser_action.addObject("LIFT_TURN_ONCE", new ModeSelection(LIFT_TURN_ONCE));
    ...
    chooser_remote_scale_action.addDefault(
        "REMOTE_SCALE_CUBE_DROP", new ModeSelection(REMOTE_SCALE_CUBE_DROP));
    chooser_remote_scale_action.addObject(
        "REMOTE_SCALE_STANDBY", new ModeSelection(REMOTE_SCALE_STANDBY));
  ...
  public int getPosition() {
    ...
    if (pos_selection.mode != POS_UNDEFINED) return pos_selection.mode;
  ...
  public int getRightLeftPriority() {
    ...
    if (right_left_priority_selection.mode != SCALE) return right_left_priority_selection.mode;
  ...
  public int getRemoteScaleAction() {
    ...
    if (remote_scale_action.mode != REMOTE_SCALE_CUBE_DROP) return remote_scale_action.mode;
