...
public class HardwareIDs {
  ...
  // encoder variables
  // public static final int ENCODER_PULSES_PER_REV = 256*4;  // 63R  - on the competition bot
  // motors
  public static final double ENCODER_PULSES_PER_REV =
      256 * 4; // 63R  - on the competition bot motors

  // public static final double INCHES_PER_REV = (6 * 3.14159);   // 6-in diameter wheel
  // (theoretical)
